...
class JiraLoginTest extends DuskTestCase
{
    ...
    public function testProdJiraLoginPage()
    {
        $this->browse(function (Browser $browser) {
            ...
            $browser->screenshot(time() . "-testProdJiraLoginPage-screenshot");
    ...
    public function testDevJiraLoginPage()
    {
        $this->browse(function (Browser $browser) {
            ...
            $browser->screenshot(time() . "-testDevJiraLoginPage-screenshot");
            $test = $browser->driver->getPageSource();
        });
    }
    ...
    public function testProdWikiLoginPage()
    {
        $this->browse(function (Browser $browser) {
            ...
            $browser->screenshot(time() . "-testProdWikiLoginPage-screenshot");
            $test = $browser->driver->getPageSource();
        });
    }
    ...
    public function testDevWikiLoginPage()
    {
        $this->browse(function (Browser $browser) {
            ...
            $browser->screenshot(time() . "-testDevWikiLoginPage-screenshot");
            $test = $browser->driver->getPageSource();
        });
    }
